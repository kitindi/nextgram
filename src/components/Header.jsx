      ...
      <div className="col-span-3">
        {session ? (
          <div className="flex items-start space-x-3 ">
            ...
            <div className="py-2">{/* <p className="text-[16px] font-semibold">{session.user.name}</p> */}</div>
          </div>
        ) : (
          <div className="flex items-start space-x-3 ">
            <div className="w-16 h-16 rounded-full bg-black text-white text-2xl flex items-center justify-center font-bold">AS</div>
            <div className="py-2">
